...
from schemabridge.connectors.snowflake import _discovery_queries as queries
from schemabridge.connectors.snowflake import _discovery_commands as commands
