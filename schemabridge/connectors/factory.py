...
SUPPORTED_CONNECTORS: dict[str, str] = {
    "demo": "schemabridge.connectors.demo.connector",
    "sqlserver": "schemabridge.connectors.sqlserver.connector",
    "mysql": "schemabridge.connectors.mysql.connector",
    "postgresql": "schemabridge.connectors.postgresql.connector",
    "snowflake": "schemabridge.connectors.snowflake.connector",
}
...
class ConnectorFactory:
    ...
    def create(connector_type: str | None = None) -> DatabaseConnector:
        ...
        if not connector_name:
            from schemabridge.config import Config
