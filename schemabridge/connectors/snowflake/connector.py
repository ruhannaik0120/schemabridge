...
from schemabridge.connectors.snowflake import _discovery_queries as discovery_queries
from schemabridge.connectors.snowflake._discovery_commands import _show_primary_keys_command
