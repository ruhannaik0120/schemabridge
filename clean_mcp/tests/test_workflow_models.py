...
def test_transition_matrix_has_exact_ordinary_and_terminal_policy():
 ordinary=[(MigrationWorkflowStatus.DRAFT,MigrationWorkflowStatus.DISCOVERED),(MigrationWorkflowStatus.DISCOVERED,MigrationWorkflowStatus.MAPPING_PROPOSED),(MigrationWorkflowStatus.MAPPING_PROPOSED,MigrationWorkflowStatus.MAPPING_APPROVED),(MigrationWorkflowStatus.MAPPING_APPROVED,MigrationWorkflowStatus.EXECUTION_READY),(MigrationWorkflowStatus.EXECUTION_READY,MigrationWorkflowStatus.EXECUTING),(MigrationWorkflowStatus.EXECUTING,MigrationWorkflowStatus.EXECUTED),(MigrationWorkflowStatus.EXECUTED,MigrationWorkflowStatus.VALIDATION_READY),(MigrationWorkflowStatus.EXECUTED,MigrationWorkflowStatus.VALIDATING),(MigrationWorkflowStatus.VALIDATION_READY,MigrationWorkflowStatus.VALIDATING),(MigrationWorkflowStatus.VALIDATING,MigrationWorkflowStatus.VALIDATED),(MigrationWorkflowStatus.VALIDATING,MigrationWorkflowStatus.VALIDATION_REVIEW_REQUIRED),(MigrationWorkflowStatus.VALIDATING,MigrationWorkflowStatus.VALIDATION_RECOVERY_REQUIRED)]
